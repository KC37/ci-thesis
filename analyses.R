...
diagnostic.test<-function()
{
  ...
  #we perform McNemar chi-squared test for our binary data (superficial/deep invasion)
  ...
  minv.data<-table(minv.MRI,minv.histo)
  mcnemar.test(minv.data)
  mcnemar.test(minv.data,correct=FALSE)
  #p-val>0.5=>we cannot reject the null hypothesis that 
